 ...
 * 重构之前的代码
 */
public class OldAveragePerformanceResolver {
    ...
    public static double resolve(
        ...
        return vtmRecords.stream()
            ...
            .filter(OldAveragePerformanceResolver::isStatementNeeded)
    ...
    /**
     * 用来减少代码重复的函数，和 {@link OldAveragePerformanceResolver#resolveExamScore(List, boolean)} )} 一起看
     *
     * @param rankBeginIdx
